...
import inventoryLogo from "./img/inventory.jpg";
...
function Servicedetails() {
    ...
    // Navigate to Add New Inventory Page
    const handleAddNewInventory = () => {
        navigate("/admin/add_inventory");  // Use navigate instead of history.push
    };
    ...
    return (
        <div className="showservices">
            ...
            <div className="add-inventory-btn">
                <button onClick={handleAddNewInventory}>Add New Inventory</button>
            </div>
                        ...
                        {showcustomer.map((e1) => (
                            <tr key={e1._id}>
                                ...
                                <td className="dback no-print">
                                    <a href={`/admin/update_service/${e1._id}`} className="no-print">Edit</a>
